...
public class MoneyDisplayView : MonoBehaviour
{
    ...
    {
        moneyDisplay.DOScale(new Vector3(1.3f, 1.3f, 1.3f), 0.1f).OnComplete(() => moneyDisplay.DOScale(defaultMoneyTableScale, 0.2f));
    }
